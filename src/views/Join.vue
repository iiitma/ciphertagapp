...
<section class="section-hero section-shaped my-0">
    ...
    <img alt="Image placeholder" src="img/theme/team-4-800x800.jpg">
                    ...
                    <template>
                        ...
                        <p v-if="!alt" class="spartan-medium text-center mb-1">Room: {{ room }}</p>
                        <p v-if="error[0]" class="text-danger spartan-medium text-center">{{error[1]}}</p>
                        <form v-if="!spectate" role="form" @submit.prevent="join()">

                            <div v-if="alt">
                                <label class="spartan-regular ">Enter Room ID</label>
                                <base-input label="" name="username" class="mb-3 spartan-medium" v-model="room" placeholder="Room ID" addon-left-icon="ni ni-user-02">
                                </base-input>
                            </div>

                            <label class="spartan-regular ">To enter the room, choose a nickname.</label>
                            <base-input label="" name="username" class="mb-3 spartan-medium" v-model="username" placeholder="Nickname" addon-left-icon="ni ni-user-02">
                            </base-input>

                            <div class="text-center">
                                <base-button v-if="!loading" type="primary" nativeType="submit" class="my-4 text-capitalize">Join Room</base-button>
                            ...
                            <div class="text-center">
                                ...
                                <router-link class="spartan-medium mx-auto" to="/create">or create a room</router-link>
                            </div>

                        </form>

                        <form v-if="spectate" role="form" @submit.prevent="joinSpectate()">
                            ...
                            <div class="text-center">
                                <base-button v-if="!loading" type="primary" nativeType="submit" class="my-4 text-capitalize">Spectate Room</base-button>
                                <div v-else class="loader ">
                                    <svg viewBox="0 0 80 80">
                                        <rect x="8" y="8" width="64" height="64"></rect>
                                    </svg>
